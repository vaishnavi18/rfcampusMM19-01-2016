 ...
 */
@Entity
@Table(name = "transaction.fees_refund_feehead_transaction")
public class FeesRefundFeeheadTransactionEntity implements Serializable {
    ...
    public String toString() {
        return "FeesRefundFeeheadTransactionEntity [feeHeadId=" + feeHeadId + ", amount=" + amount + "]";
    }

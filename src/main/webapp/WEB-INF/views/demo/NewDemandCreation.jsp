																...
																$
																		.each(
																				...
																				function(
																						index,
																						branch) {
																					text += "<option value=\""+branch.branchId+"\">"
	...
	function createDemand() {
		...
		$.ajax({
			...
			success : function(response) {
				...
				if (response != 0) {
					if (demandForflag == 1) {
						alert('Demand Created for All Student');
					} else {
						alert('Demand Created for Selected Student');
					}
				}
			},
			error : function() {
								...
								<div class="table-header">
									<div class="row">
										<div class="create_project_tbl">
											...
											<!-- jaskirat singh code to tab start here -->
											<div id="tabs">
												<ul>
													<li><a href="#tabs-1">Batch Demand</a></li>
													<li><a href="#tabs-2">Per Student Demand</a></li>
															...
															<div class="col-sm-12" id="degree-list">
																...
																<div class="col-sm-6">
																	<select name="acadamicSessionId" id="acadamicSessionId"
																		placeholder="Please Enter Batch" class="form-control">
													...
													<div class="form-horizontal">
														...
														<div class="form-group">
															<div class="col-sm-12" id="degree-list">
																<div class="col-sm-6">
																	<span id="ContentPlaceHolder1_lblParent"
																		class="control-label">Create Demand for
																		Semester<span
																		style="color: #FF0000; font-weight: bold">*</span>
																	</span>
																</div>
												...
												<div class="col-md-6">
													<div class="form-horizontal">
														<div class="form-group">
															<div class="col-sm-12" id="degree-list">
																<div class="col-sm-6">
																	...
																	<span id="ContentPlaceHolder1_lblParent"
																		class="control-label">Registration No<span
																		style="color: #FF0000; font-weight: bold">*</span></span>

																</div>
																<div class="col-sm-6">
																<input name="" type="text" maxlength="100"
																			id="" tabindex="4" class="form-control"
														...
														<div class="form-group">
															<div class="col-sm-12" style="height: 25.15px">
																<div class="col-sm-6">
												...
												<div class="" style="text-align: center">
													<div class="col-sm-12">
														<button type="button" title="Create Demand"
															...
															id="create-selected-demand-btn">Create Demand

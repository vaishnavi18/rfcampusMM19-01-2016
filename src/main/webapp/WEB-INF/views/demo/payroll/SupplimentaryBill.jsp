					...
					<div class="second-column one-child-container relative ">
						...
						<div id="my_documents_container" style=""
							class="doc-container column-one clearfix ">
					 		...
					 		<div class="grid-header text">Supplementary Bill Dates</div>
									...
									<div class="row">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<div class="col-sm-4 ">
													<div class="control-label">
														Grade Pay <span style="color: #FF0000; font-weight: bold">
															*</span>
													</div>
												</div>
												<div class="col-sm-6">
													...
													<tbody role="alert" aria-live="polite" aria-relevant="all">
														...
														<tr class="odd">
															<td style="width: 40%"><input type="checkbox"
																name="" id="test" value="1" /> <label>HRA</label></td>
											...
											<div class="form-horizontal">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
															...
															readonly="readonly" maxlength="100"
															id="admissionEndDateString" tabindex="4"
															class="form-control " placeholder="Total Deduction">
													</div>
												</div>
										...
										<div class="col-sm-12">
											...
											<div class="col-sm-9">
												<input type="text" placeholder="Designation"
													class="form-control" maxlength="40" readonly="readonly"
													name="">
											</div>
										</div>
									</div>

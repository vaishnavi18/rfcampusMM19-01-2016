...
<title>Monthly Attendance in Master File | RF-Campus</title>
				...
				<div class="">
					...
					<div class="second-column one-child-container relative ">
						...
						<div id="my_documents_container" style=""
							...
							<div class="grid-header text">Select Payhead/Staff </div>
							...
							<div class="col-sm-12">
								<div
				 				 	style="height: 37px; border-radius: 5px; text-align: left; padding: 10px;margin-bottom:10px" 
								  	class="col-xs-12 col-sm-12 bg-primary" id="confirm_div">
&nbsp;&nbsp; Total Employee :   &nbsp; &nbsp; &nbsp; &nbsp; Total Amount in GCA :  </div>
							</div>

							<div class="grid-title">
								<div class="pull-left">Monthly Charge</div>
								<div class="clear"></div>
							</div>

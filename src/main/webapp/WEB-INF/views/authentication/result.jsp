...
<head>
	...
	<style type="text/css">.jqstooltip { position: absolute;left: 0px;top: 0px;background: rgb(0, 0, 0) transparent;background-color: rgba(0,0,0,0.6);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000);-ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr=#99000000, endColorstr=#99000000)";color: white;font: 10px arial, san serif;text-align: left;white-space: nowrap;padding: 5px;border: 1px solid white;z-index: 10000;}.jqsfield { color: white;font: 10px arial, san serif;text-align: left;}</style>
	</head>
                    ...
                    <div class="panel-body">
                        <div class="text-center">
                         <!--  <img src="https://cloud.digitalocean.com/assets/cloud-logo-0efc9110ac89b1ea38fc7ee2475a3e87.svg" class="login" height="70"> -->
                          <h3 class="text-center">Password Reset Successfull</h3>
                            <div class="panel-body">
                              ...
                              <form class="form" action="./forgetPassword" method="post"><!--start form--><!--add form action as needed-->
                                <fieldset>
                                  <div class="form-group">
                                       ...
                                       <a href="#"  onclick="document.location='../login'" >Click to Login with new Password !! </a>
                                  </div>
                                </fieldset>
                              </form><!--/end form-->
